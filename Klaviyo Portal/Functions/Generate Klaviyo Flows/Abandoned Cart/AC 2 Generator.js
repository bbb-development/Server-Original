...
async function generateAC2(brandData, emailID) {
...
async function test() {
    const newTemplateID = await templateFunctions.cloneTemplate('X7qBvi', 'AC 2');
    console.log(newTemplateID);
    generateAC2(crystalenergy, newTemplateID);
}

export default generateAC2;
