import { getRandomImageFromAlbum } from './imgBB Integration.js';
import { womanNames } from './assistant_names.js';
...
export async function getEmailImages() {
  console.log('🔍 Fetching random images for all email templates...');
