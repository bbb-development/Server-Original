...
export async function generateTemplate(data) {
  const images = await getRandomImageFromAlbum("gZMvTh", "WF Email #3", 1);
  ...
  return (
    {
      ...
      "block-1744989981349": {
        ...
        "data": {
          ...
          "props": {
            "text": "Less than 3 hours remaining to save 10% OFF\nyour entire order."
          }
        }
      },
      "block-1744990112916": {
