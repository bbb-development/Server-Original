...
export async function generateTemplate(data) {
  const images = await getRandomImageFromAlbum("Wxzp4j", "AC Email #3", 1);
  ...
  return (
    {
      ...
      "block-1745496178781": {
        ...
        "data": {
          ...
          "props": {
            "url": "https://raw.githubusercontent.com/ribalina/Test-SVG-upload/633979a37ac3b6f8f5ea0d9c8447cc3300a4e3a5/ac-email-3-test-html.gif",
            "alt": data.brand.url,
            "linkHref": null,
            "contentAlignment": "middle"
          }
      ...
      "block-1744989981349": {
        ...
        "data": {
          ...
          "props": {
            "text": "This is our final reminder.\nLess than 3 hours remain!"
          }
        }
      },
      "block-1744990112916": {
      ...
      "block-1745016283730": {
        ...
        "data": {
          ...
          "props": {
            "text": "Last hours to save a whopping 15% OFF your entire purchase."
          }
        }
      },
      "block-1745016882790": {
